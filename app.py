...
client = motor.motor_asyncio.AsyncIOMotorClient("mongodb+srv://ZukoUWI:ZukoUWI@cluster0.rlhtdtb.mongodb.net/?retryWrites=true&w=majority",tls=True, tlsAllowInvalidCertificates=True)
